...
def GUI():
    ...
    while True:
        ...
        BotTimeZone = OptionMenu(*(f, BotTimeZoneVar) + tuple(BotTimeZone))
        ...
        TeamTimeZone = OptionMenu(*(f, TeamTimeZoneVar) + tuple(TeamTimeZone))
        ...
        TeamCode = OptionMenu(*(f, TeamCodeVar) + tuple(TeamCode))
        ...
        SuggestedSort = OptionMenu(*(f, SuggestedSortVar) + tuple(SuggestedSort))
        ...
        PostTime = OptionMenu(*(f, PostTimeVar) + tuple(PostTime))
        ...
        PreThreadTime = OptionMenu(*(f, PreThreadTimeVar) + tuple(PreThreadTime))
